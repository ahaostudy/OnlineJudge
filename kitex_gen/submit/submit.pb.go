...
var file_submit_proto_rawDesc = []byte{
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x1e, 0x0a, 0x0a, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73,
	0x43, 0x6f, 0x64, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0a, 0x53, 0x74, 0x61, 0x74,
	0x75, 0x73, 0x43, 0x6f, 0x64, 0x65, 0x22, 0x38, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x4e, 0x6f, 0x74,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x12, 0x1e, 0x0a, 0x0a, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x43, 0x6f,
	0x64, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0a, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73,
	0x43, 0x6f, 0x64, 0x65, 0x32, 0xb8, 0x09, 0x0a, 0x0d, 0x53, 0x75, 0x62, 0x6d, 0x69, 0x74, 0x53,
...
var file_submit_proto_msgTypes = make([]protoimpl.MessageInfo, 38)
var file_submit_proto_goTypes = []interface{}{
	...
	(*GetNoteRequest)(nil),            // 26: submit.GetNoteRequest
	(*GetNoteResponse)(nil),           // 27: submit.GetNoteResponse
	(*GetNoteListRequest)(nil),        // 28: submit.GetNoteListRequest
	(*GetNoteListResponse)(nil),       // 29: submit.GetNoteListResponse
	(*CreateNoteRequest)(nil),         // 30: submit.CreateNoteRequest
	(*CreateNoteResponse)(nil),        // 31: submit.CreateNoteResponse
	(*DeleteNoteRequest)(nil),         // 32: submit.DeleteNoteRequest
	(*DeleteNoteResponse)(nil),        // 33: submit.DeleteNoteResponse
	(*UpdateNoteRequest)(nil),         // 34: submit.UpdateNoteRequest
	(*UpdateNoteResponse)(nil),        // 35: submit.UpdateNoteResponse
	nil,                               // 36: submit.GetSubmitStatusResponse.SubmitStatusEntry
	nil,                               // 37: submit.GetAcceptedStatusResponse.AcceptedStatusEntry
}
var file_submit_proto_depIdxs = []int32{
	...
	36, // 5: submit.GetSubmitStatusResponse.SubmitStatus:type_name -> submit.GetSubmitStatusResponse.SubmitStatusEntry
	37, // 6: submit.GetAcceptedStatusResponse.AcceptedStatus:type_name -> submit.GetAcceptedStatusResponse.AcceptedStatusEntry
	1,  // 7: submit.GetLatestSubmitsResponse.SubmitList:type_name -> submit.Submit
	2,  // 8: submit.GetNoteResponse.Note:type_name -> submit.Note
	2,  // 9: submit.GetNoteListResponse.NoteList:type_name -> submit.Note
	2,  // 10: submit.CreateNoteRequest.Note:type_name -> submit.Note
	15, // 11: submit.GetSubmitStatusResponse.SubmitStatusEntry.value:type_name -> submit.SubmitStatus
	3,  // 12: submit.SubmitService.Debug:input_type -> submit.DebugReqeust
	5,  // 13: submit.SubmitService.Submit:input_type -> submit.SubmitRequest
	7,  // 14: submit.SubmitService.SubmitContest:input_type -> submit.SubmitContestRequest
	9,  // 15: submit.SubmitService.GetSubmitResult:input_type -> submit.GetSubmitResultRequest
	11, // 16: submit.SubmitService.GetSubmitList:input_type -> submit.GetSubmitListRequest
	13, // 17: submit.SubmitService.GetSubmit:input_type -> submit.GetSubmitRequest
	16, // 18: submit.SubmitService.GetSubmitStatus:input_type -> submit.GetSubmitStatusRequest
	18, // 19: submit.SubmitService.IsAccepted:input_type -> submit.IsAcceptedRequest
	20, // 20: submit.SubmitService.GetAcceptedStatus:input_type -> submit.GetAcceptedStatusRequest
	22, // 21: submit.SubmitService.GetLatestSubmits:input_type -> submit.GetLatestSubmitsRequest
	24, // 22: submit.SubmitService.DeleteSubmit:input_type -> submit.DeleteSubmitRequest
	26, // 23: submit.SubmitService.GetNote:input_type -> submit.GetNoteRequest
	28, // 24: submit.SubmitService.GetNoteList:input_type -> submit.GetNoteListRequest
	30, // 25: submit.SubmitService.CreateNote:input_type -> submit.CreateNoteRequest
	32, // 26: submit.SubmitService.DeleteNote:input_type -> submit.DeleteNoteRequest
	34, // 27: submit.SubmitService.UpdateNote:input_type -> submit.UpdateNoteRequest
	4,  // 28: submit.SubmitService.Debug:output_type -> submit.DebugResponse
	6,  // 29: submit.SubmitService.Submit:output_type -> submit.SubmitResponse
	8,  // 30: submit.SubmitService.SubmitContest:output_type -> submit.SubmitContestResponse
	10, // 31: submit.SubmitService.GetSubmitResult:output_type -> submit.GetSubmitResultResponse
	12, // 32: submit.SubmitService.GetSubmitList:output_type -> submit.GetSubmitListResponse
	14, // 33: submit.SubmitService.GetSubmit:output_type -> submit.GetSubmitResponse
	17, // 34: submit.SubmitService.GetSubmitStatus:output_type -> submit.GetSubmitStatusResponse
	19, // 35: submit.SubmitService.IsAccepted:output_type -> submit.IsAcceptedResponse
	21, // 36: submit.SubmitService.GetAcceptedStatus:output_type -> submit.GetAcceptedStatusResponse
	23, // 37: submit.SubmitService.GetLatestSubmits:output_type -> submit.GetLatestSubmitsResponse
	25, // 38: submit.SubmitService.DeleteSubmit:output_type -> submit.DeleteSubmitResponse
	27, // 39: submit.SubmitService.GetNote:output_type -> submit.GetNoteResponse
	29, // 40: submit.SubmitService.GetNoteList:output_type -> submit.GetNoteListResponse
	31, // 41: submit.SubmitService.CreateNote:output_type -> submit.CreateNoteResponse
	33, // 42: submit.SubmitService.DeleteNote:output_type -> submit.DeleteNoteResponse
	35, // 43: submit.SubmitService.UpdateNote:output_type -> submit.UpdateNoteResponse
